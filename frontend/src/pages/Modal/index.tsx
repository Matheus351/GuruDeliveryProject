                        ...
                        <div style={{ minHeight: 400 }} className="row">
                            ...
                            <div className="col p-0 align-self-center">
                                ...
                                <img
                                    ...
                                    width={'100%'} className='image-fluid' src="https://i.imgur.com/eFWRUuR.jpg" alt="" />
                            ...
                            <div className="col">
                                ...
                                <div className='d-flex align-items-center justify-content-end mt-1'>
                                    ...
                                    <div className='d-flex border me-2'>
                                        <div className="p-2">
                                            <FaMinus onClick={removeProductSelected} color='gray' cursor={'pointer'} size={25} />
                                        </div>
                                        <div className='p-2'>
                                            {total}
                                        </div>
                                        ...
                                        <div className="p-2">
                                            <FaPlus onClick={setProductSelected} color='orange' cursor={'pointer'} size={25} />
                                        </div>
                                    </div>
